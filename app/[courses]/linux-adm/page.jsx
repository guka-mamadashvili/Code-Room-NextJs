      ...
      <div className="flex flex-col justify-center items-center text-center p-5">
        <div>
          <ul className="flex space-x-7 text-lg max-sm:flex-col max-sm:space-x-0 max-sm:space-y-2">
            ...
            <Link href="/courses/linux-adm" className="hover:underline bg-mtavari rounded-lg text-white px-2">Linux Administration</Link>
        ...
        <div className="flex flex-wrap justify-center items-center p-6">
          {Courses.filter((course) => course.courseCategory === "Linux-Administration").map((course) => (
