      ...
      <div className="flex flex-col justify-center items-center text-center p-5">
        <div>
          ...
          <Link href="/courses/software-dev" className="hover:underline">Software Development</Link>
            ...
            <Link href="/courses/mobile-dev" className="hover:underline bg-mtavari rounded-lg text-white px-2">Mobile Development</Link>
          </ul>
        </div>
        <div className="flex flex-wrap justify-center items-center p-6">
          {Courses.filter((course) => course.courseCategory === "Mobile-Development").map((course) => (
